...
namespace Sitecore.ItemBucket.Kernel.Util
{
    ...
    public class SearchHelper
    {
        ...
        private static IDictionary<string, Sitecore.Search.Index> GetSearchIndexes()
        {
        ...
        internal static List<Sitecore.Search.Index> GetIndexes()
        {

            var availableIndexes = new List<Sitecore.Search.Index>();
            foreach (var index in GetSearchIndexes())
            {
                availableIndexes.Add(index.Value);
            }
            ...
            if (templates.Any())
            {
                foreach (var template in templates)
                {
                    ...
                    else
                    {
                        ...
                        if (!IdHelper.IsGuid(template.Value))
                        {
