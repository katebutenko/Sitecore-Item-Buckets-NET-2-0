        ...
        public class DatedLinkResolver
        {
            ...
            public Item Process(string url)
            {
                ...
                if (pathSegments.Any())
                {
                    ...
                    {
                        itemToReturn = "/" + string.Concat("/", pathSegments);
                    }
                    else
                    {
                        itemToReturn = "/sitecore/content/" + string.Concat("/", pathSegments);
                    }
                }
                ...
                if (pathSegments.Any())
                {
                    ...
                    {
                        itemToReturn = Sitecore.Context.Site.StartPath + "/" + string.Concat("/", pathSegments);
                    }
                }
